SELECT ORIGEM, TOTAL_PILOTOS, CONTINENTE, COUNTRY.NAME AS PAIS, LATITUDE, LONGITUDE FROM
...
GROUP BY nationality order by COUNT(driverID) desc) TCONTINENTE
INNER JOIN country COUNTRY
ON TCONTINENTE.ORIGEM = COUNTRY.NATIONALITY;